...
"
    ...
    when 5 then take_place_in_wagon
...
def set_route_to_train
  return puts 'Сначала необходимо создать поезд.' if @trains.empty?
  return puts 'Сначала необходимо создать маршрут.' if @routes.empty?
...
def take_place_in_wagon
  ...
  if train.type == :passenger
    take_place_passenger_wagon(wagon)
  elsif train.type == :cargo
    take_place_cargo_wagon(wagon)
  end
end

def take_place_passenger_wagon(wagon)
...
def take_place_cargo_wagon(wagon)
...
def to_next_station
  ...
  return unless route_in_train?(train)
...
def station_in_route?(station, route)
  route.stations.each do |station_from_route|
...
def select_wagon(train)
  ...
  loop do
    puts 'Выберите вагон.'
    train.wagons.each_with_index { |_wagon, i| puts "Вагон '#{i}'." }
    choice = gets.chomp
...
def create_test_data
  ...
  @stations.push(station1, station2, station3)
  route1 = Route.new(station1, station2)
  route2 = Route.new(station1, station3)
  @routes.push(route1, route2)
  train1 = CargoTrain.new('ТПЗ-50')
  train2 = PassengerTrain.new('Сапсн')
  train1.add_wagon(CargoWagon.new(50))
  train1.add_wagon(CargoWagon.new(70))
  train1.add_wagon(CargoWagon.new(90))
  train2.add_wagon(PassengerWagon.new(20))
  train2.add_wagon(PassengerWagon.new(40))
